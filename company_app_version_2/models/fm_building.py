...
class Building(models.Model):
    ...
    def _mt_to_feet(self):
        self.under_root_area_as_feet = self.under_root_area_as_meter * 3.28
        """self.under_root_area_as_feet = self.under_root_area_as_meter / .3048 % 1 * 12""" """ this is for mt to inch convertion"""
